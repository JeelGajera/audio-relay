...
android {
    ...
    // AGP 9 provides Kotlin support itself (the kotlin-android plugin is no
    // longer applied) and derives the Kotlin jvmTarget from these, so there is
    // no separate kotlinOptions/compilerOptions block to keep in sync.
    compileOptions {
